...
<div class="modal">
    ...
    <div class="modal-fade-screen">
        <div class="modal-inner">
            <div class="modal-close" for="modal-1"></div>
            <h1>4Staying</h1>
            <p class="modal-intro">4Staying is een website waar flexwerkers een huis of appartement kunnen huren voor een bepaalde periode. Daarnaast is het ook mogelijk voor particulieren om hun huis, kamer of appartement te verhuren aan deze flexwerkers. Dit is het grootste project waar ik aan meegewerkt heb en daardoor heb ik ook enorm veel geleerd om dit soort projecten nog beter aan te kunnen pakken in de toekomst. Samen met 3 andere ZZP'ers heb ik dit project mogen doen.</p>
            <p>
